 ...
 *   ];
 *
 *   $adapter = new Hybridauth\Provider\Unomas($config);
 *
 *   try {
...
class Unomas extends OAuth2
{
    ...
    public function getUserProfile()
    {
        ...
        if( strpos($userProfile->email,'unomas-mebel.ru')==false) {
            throw new UnexpectedApiResponseException('Domain not allowed');
        }
